...
public class VoiceActivity extends RxAppCompatActivity implements AudioRecorder.OnErrorListener {
    ...
    public void onError(int error) {
        runOnUiThread(
                () -> Toast.makeText(VoiceActivity.this, "Error code: " + error, Toast.LENGTH_SHORT)
                        .show());
    }
}